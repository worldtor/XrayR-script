# 此为完整备份XrayR的v0.8.0版本，一键脚本完整安装。我们大家都尊重XrayR的作者，期待作者回归。
# XRayR
...
```
bash <(curl -Ls https://raw.githubusercontent.com/worldtor/XrayR-script/master/install.sh)
```
# Docker 安装
...
```
1. `git clone https://github.com/Misaka-blog/XrayR-script`
2. `cd XrayR-script`
3. 编辑config。
